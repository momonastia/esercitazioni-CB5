...
search_btn.addEventListener("click", (e) => {
  ...
  getDirector(nameEl.value).then((regista) => {
    ...
    if (regista[0]._id != undefined) {
      idEl.value = regista[0]._id;
      nameEl.value = regista[0].nome;
      surnameEl.value = regista[0].cognome;
      data_nascitaEl.value = regista[0].data_nascita;
      riconoscimentiEl.value = regista[0].riconoscimenti;
      inizio_attivitaEl.value = regista[0].inizio_attivita;
      fine_attivitaEl.value = regista[0].fine_attivita;
      in_attivitaEl.value = regista[0].in_attivita;
    }
  });
});
