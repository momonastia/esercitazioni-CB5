...
const createCard = (url, nome, tipo, parent, id) => {
  ...
  cardEl.addEventListener("click", () => {
    ...
    elementEdit.id.value = id;
    elementEdit.name.value = titleEl.textContent;
    elementEdit.type.value = bodyCardEl.textContent;
  });
...
export { c, q, GET, POST, uuidv4, createCard, PATCH };
